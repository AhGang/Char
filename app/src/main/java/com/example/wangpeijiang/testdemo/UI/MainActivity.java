package com.example.wangpeijiang.testdemo.UI;
...
import com.example.wangpeijiang.testdemo.Adapter.MsgAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initMsgs() {
        ...
        msgList.add(msg2);
        Msg msg3 = new Msg("This is Bill.",Msg.TYPE_RECEIVER);
        msgList.add(msg3);
